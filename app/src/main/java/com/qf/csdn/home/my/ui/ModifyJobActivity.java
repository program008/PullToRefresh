 ...
 * on 2016/2/5.
 */
public class ModifyJobActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void initViews() {
        setRightText("保存");
        setTitleText("修改职位");
        nickname = (EditText) findViewById(R.id.my_modify_job_editText);
        editdelect = (ImageView) findViewById(R.id.my_modify_job_editdelect);
    }
    ...
    public void onClick(View v) {
        if (v.getId()==R.id.my_modify_job_editdelect){
            nickname.setText("");
        }
    }
}
